...
HD_PWD='/home/iyasnyy/Desktop/Practica_final/PWM_IP/managed_ip_project/managed_ip_project.tmp/axi_pwm_generator_v1_0_project/axi_pwm_generator_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_pwm_generator_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_pwm_generator_v1_0.tcl
